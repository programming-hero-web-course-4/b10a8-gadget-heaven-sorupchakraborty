  ...
  return (
    <div className="container mx-auto ">
      ...
      <div className="text-center bg-[#9538E2] rounded-2xl p-5">
        <h2 className="text-4xl text-white font-bold py-4">Dashboard</h2>
        <p className="text-white max-w-[60%] mx-auto">Uncover the latest gadgets designed to elevate your world. From innovative smart devices to trendsetting accessories - find it all here at TechVerse!</p>
        <button
